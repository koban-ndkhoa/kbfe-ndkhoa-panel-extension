...
After enabling the extension, click `Panel -> kbfe-ndkhoa-panels -> Default Panel` in the main menu bar to open the default panel of the extension.

To send a message to the default panel, click `Developer -> kbfe-ndkhoa-panels -> Send Message to Panel` at the top of the menu. If the default panel exists, the `hello` method of the panel will be called.
